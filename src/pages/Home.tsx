...
const StatCard = ({ value, label, icon: Icon, delay }: { value: string; label: string; icon: any; delay: number }) => {
  return (
    <motion.div
      ...
      className="flex flex-col items-center gap-2 sm:gap-3 p-4 sm:p-5 md:p-6 rounded-2xl md:rounded-3xl border border-white/10 backdrop-blur-sm"
      style={{ background: 'rgba(255,255,255,0.04)' }}
    >
      <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl flex items-center justify-center" style={{ background: 'linear-gradient(135deg,#38bdf8,#6366f1)' }}>
        <Icon size={18} className="text-white sm:w-[22px] sm:h-[22px]" />
      </div>
      <span className="text-2xl sm:text-4xl md:text-5xl font-black text-white">{value}</span>
      <span className="text-white/50 text-[10px] sm:text-xs md:text-sm font-semibold uppercase tracking-wider sm:tracking-widest text-center">{label}</span>
    </motion.div>
  );
};
...
const ArtCard = ({
  ...
  return (
    <motion.div
      ...
      className="flex items-start gap-3 sm:gap-4 p-3.5 sm:p-4 md:p-5 rounded-2xl border border-white/8 hover:border-brand-accent/30 hover:bg-white/5 transition-all duration-300 group cursor-default"
    >
      <div className="w-9 h-9 sm:w-10 sm:h-10 md:w-11 md:h-11 rounded-xl flex items-center justify-center flex-shrink-0 transition-all duration-300 group-hover:scale-105"
        style={{ background: 'rgba(56,189,248,0.15)', border: '1px solid rgba(56,189,248,0.2)' }}>
        <Icon size={18} className="text-brand-accent sm:w-5 sm:h-5" />
      </div>
      <div className="min-w-0">
        <h3 className="font-bold text-white text-sm sm:text-base mb-0.5 md:mb-1">{title}</h3>
        <p className="text-white/50 text-xs sm:text-sm leading-relaxed line-clamp-2 sm:line-clamp-none">{desc}</p>
      </div>
    </motion.div>
  );
};
...
const Home = () => {
  ...
  return (
    <div className="w-full">
      ...
      {/* ══ FRAME 2: About ═════════════════════════════════════════════ */}
      <section id="about" className="snap-start relative md:sticky md:top-0 z-10 min-h-[100dvh] md:h-[100dvh] bg-[#0b1121] flex flex-col justify-center items-center w-full px-5 sm:px-6 md:px-20 py-16 md:py-0 pb-28 md:pb-0 overflow-visible md:overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          ...
          <SectionReveal direction="left">
            <span className="inline-flex items-center gap-2 text-xs font-bold tracking-[0.3em] uppercase text-brand-accent mb-4 sm:mb-6">
          ...
          <AnimatedHeading
            ...
            className="text-3xl sm:text-5xl md:text-7xl font-black text-white mb-4 sm:mb-6 md:mb-8 leading-tight sm:leading-none tracking-tighter"
            delay={0.1}
          />

          <SectionReveal direction="right" className="mb-6 sm:mb-8 md:mb-10">
            <p className="text-sm sm:text-lg md:text-xl text-white/55 leading-relaxed font-medium">
            ...
            <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
              {['Classical Arts', 'Music', 'Drama', 'Literature', 'Fine Arts', 'Folk Arts'].map((tag, i) => (
                <motion.span
                  ...
                  className="px-3.5 sm:px-4 py-1 sm:py-1.5 rounded-full text-[11px] sm:text-xs font-bold text-white/70 border border-white/10 backdrop-blur-sm"
      ...
      <section className="snap-start relative md:sticky md:top-0 z-20 min-h-[100dvh] md:h-[100dvh] bg-[#0b1121] flex flex-col justify-center w-full px-5 sm:px-6 md:px-20 py-16 md:py-0 pb-28 md:pb-0 overflow-visible md:overflow-hidden border-t border-white/5 shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          <div className="mb-6 sm:mb-10 md:mb-16">
            <SectionReveal>
              <span className="inline-flex items-center gap-2 text-xs font-bold tracking-[0.3em] uppercase text-brand-accent mb-3 sm:mb-4">
                <Star size={12} /> The Festival in Numbers
              </span>
            </SectionReveal>
            <AnimatedHeading
              text="Celebrating Excellence"
              className="text-3xl sm:text-5xl md:text-7xl font-black text-white leading-tight sm:leading-none tracking-tighter"
              delay={0.05}
            />
          </div>
          ...
          <SectionReveal direction="up" className="mt-6 sm:mt-10 md:mt-14">
            <p className="text-white/35 text-xs sm:text-sm font-medium text-center tracking-wide">
      ...
      <section className="snap-start relative md:sticky md:top-0 z-30 min-h-[100dvh] md:h-[100dvh] bg-[#0b1121] flex flex-col justify-center w-full px-5 sm:px-6 md:px-20 py-16 md:py-0 pb-28 md:pb-0 overflow-visible md:overflow-hidden border-t border-white/5 shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-20 items-center">
          ...
          <div>
            ...
            <AnimatedHeading
              ...
              className="text-3xl sm:text-4xl md:text-6xl font-black text-white leading-tight sm:leading-none tracking-tighter mb-4 sm:mb-6 md:mb-8"
              delay={0.05}
            />
            <SectionReveal direction="left">
              <p className="text-white/50 text-sm sm:text-base md:text-lg leading-relaxed mb-6 md:mb-8">
            ...
            <SectionReveal>
              <Link to="/items">
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="inline-flex items-center gap-2.5 px-6 sm:px-8 py-3 sm:py-3.5 rounded-full font-bold text-white text-xs sm:text-sm tracking-wide"
      ...
      <section id="gallery" className="snap-start relative md:sticky md:top-0 z-40 min-h-[100dvh] md:h-[100dvh] bg-[#0b1121] flex flex-col justify-center w-full px-5 sm:px-6 md:px-20 py-16 md:py-0 pb-28 md:pb-0 overflow-visible md:overflow-hidden border-t border-white/5 shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          <div className="flex justify-between items-end mb-6 sm:mb-8 md:mb-12">
            <div>
              <SectionReveal>
                <span className="inline-flex items-center gap-2 text-xs font-bold tracking-[0.3em] uppercase text-brand-accent mb-2 sm:mb-3">
                  <ImageIcon size={12} /> Captured Moments
                </span>
              </SectionReveal>
              <AnimatedHeading
                text="Festival Gallery"
                className="text-3xl sm:text-4xl md:text-6xl font-black text-white leading-tight sm:leading-none tracking-tighter"
                delay={0.05}
              />
            </div>
            <SectionReveal>
              <Link to="/gallery" className="inline-flex items-center gap-1.5 sm:gap-2 px-4 sm:px-7 py-2 sm:py-3 text-white font-bold rounded-full text-xs sm:text-sm hover:-translate-y-1 transition-all" style={{ background: 'linear-gradient(135deg,#38bdf8,#6366f1)' }}>
          ...
          {isLoadingPreview ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2.5 sm:gap-3 md:gap-4">
              {previewImages.filter(img => img && img.length > 10 && img !== 'undefined').slice(0, 6).map((img, i) => (
                <motion.div
                  ...
                  className={`rounded-2xl overflow-hidden group cursor-pointer ${i === 0 ? 'col-span-2 row-span-2 sm:col-span-2 sm:row-span-2 md:col-span-2 md:row-span-2' : ''}`}
      ...
      {hallOfFameEntries.length > 0 && (
        <div className="snap-start relative md:sticky md:top-0 z-50 bg-[#0b1121] w-full min-h-[100dvh] md:h-[100dvh] py-16 md:py-0 pb-28 md:pb-0 overflow-visible md:overflow-hidden shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
          <HallOfFameSection entries={hallOfFameEntries} />
        </div>
      )}

      {/* ══ FRAME 6/7: CTA + Footer ════════════════════════════════════ */}
      <section className="snap-start relative md:sticky md:top-0 z-[60] bg-[#0b1121] min-h-[100dvh] md:h-[100dvh] flex flex-col justify-between py-12 md:py-0 pb-16 md:pb-0 overflow-visible md:overflow-hidden border-t border-white/5 shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6 md:px-20 py-8 md:py-0">

          <SectionReveal>
            <span className="inline-flex items-center gap-2 text-xs font-bold tracking-[0.3em] uppercase text-brand-accent mb-4 sm:mb-8">
          ...
          <AnimatedHeading
            ...
            className="text-3xl sm:text-5xl md:text-8xl font-black text-white leading-tight sm:leading-none tracking-tighter mb-4 sm:mb-6 md:mb-8"
            delay={0.05}
          />

          <SectionReveal className="mb-6 sm:mb-8 md:mb-12">
            <p className="text-sm sm:text-lg md:text-xl text-white/50 max-w-2xl leading-relaxed">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4 justify-center">
              <Link to="/student-auth">
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="px-8 sm:px-10 py-3.5 sm:py-4 rounded-full font-black text-xs sm:text-sm uppercase tracking-widest text-white shadow-2xl"
                  style={{
              ...
              <Link to="/items">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.97 }}
                  className="px-8 sm:px-10 py-3.5 sm:py-4 rounded-full font-black text-xs sm:text-sm uppercase tracking-widest text-white/70 border border-white/15 hover:border-white/30 transition-colors"
                >
                  Browse Items
                </motion.button>
              </Link>
